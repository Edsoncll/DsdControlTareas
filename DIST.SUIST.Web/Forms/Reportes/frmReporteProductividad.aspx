                        ...
                        <div class="dFiltros">
                            <div class="form-group" style="margin-top: 0; margin-bottom: 0">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-2">
                                        <select id="slUsuario" class="form-control chosen" runat="server" />
                                    </div>
                                    <label class="col-sm-2 text-right">Cliente:</label>
                                    <div class="col-sm-2">
                                        <select id="slCliente" class="form-control chosen" runat="server"></select>
                                    </div>
        ...
        function fListarProductividad(filtrar) {
            ...
            $("#dtProductividad").kendoGrid({
                ...
                columns: [
                    ...
                    { field: "col_NombreProyecto", title: "Proyecto", hidden: true },
